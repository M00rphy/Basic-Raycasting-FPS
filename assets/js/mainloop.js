...
atd.main = {
    ...
    showIntro : function () {
        ...
        var ctx  = atd.main._showText("SandBox  game.", "teal", true, "pink", 50),
        ...
        image.src = "assets/graphix/lipstick_ET2.png";
    },

    showInstructions : function () {
        "use strict";

        var ctx  = atd.main._showText("SandBox Game.", "black", true, "red", 50),
            text = "Press space to continue ...",
            tw = ctx.measureText(text).width,
            image = new Image(),
            image2 = new Image(),
        ...
        image.onload = function () {
            ctx.drawImage(image, 0, 0, 128, 128,
                          Math.floor(atd.SCREEN_WIDTH * 0.2), 40, 128, 128);
        }

        image2 = new Image();
        image2.src = "assets/graphix/lipstick_demon2.png";
        image2.onload = function () {
            ctx.drawImage(image2, 0, 0, 128, 128,
                          Math.floor(atd.SCREEN_WIDTH * 0.2), 160, 128, 128);
        };
        ...
        text = "Pink dots are demons and green dots are aliens.";
        ctx.fillText(text, Math.floor(atd.SCREEN_WIDTH * 0.33), 390);
        text = "Red dots are killed demons and white dots are killed aliens";
        ctx.fillText(text, Math.floor(atd.SCREEN_WIDTH * 0.27), 410);
    ...
    initEngine : function () {
        ...
        atd.main._playSound("assets/sfx/lipstick_get_ready.ogg");
    ...
    start : function () {
        ...
        var height = window.innerHeight - 20,
            controller = new ge.MainController(atd.SCREEN_ID, atd.MINIMAP_ID, {
                ...
                wallTextureAtlas    : "assets/graphix/walls2.png",
                wallTextureMapping  : {
                    "1" : [0, 0],   // Texture tiles
                    "2" : [0, 64], 
                    "3" : [0, 128],
                ...
                ceilingSolidColor     : undefined,
                floorSolidColor       : "#F7D358",
...
atd.Player = ge.Class.create(ge.default_eventHandler, {
    ...
    init : function () {
        ...
        this._gunSprite.src = "assets/graphix/grenade1.png";
        ...
        this._animationOffset = 0; //hand animation initial frame offset

        // Crosshair, aim, reticule
        this._screenMiddle = atd.SCREEN_WIDTH / 2;
        this._screenMiddleY = atd.SCREEN_HEIGHT / 2;
        this._killZoneStart = this._screenMiddle - 46;
        this._killZoneEnd = this._screenMiddle + 46;
        this._killZoneStartY = this._screenMiddleY - 64;
        this._killZoneEndY = this._screenMiddleY + 64;
            ...
            for (var i=sprites.length-1; i >= 0; i--) {
                ...
                if (sprite.hitList.length > 0) {
                    ...
                    if ((x1 <= this._killZoneEnd && x2 >= this._killZoneEnd) ||
                        ...
                        //killzone reactangle debug print thing, aim, reticule
    ...
    fire : function (state) {
        ...
        var fireLoop = ge.bind(function () {
            ...
            if (this._animationOffset > 128 && this._animationOffset < 384) {
            ...
            //Gun animation, 320 for the raccoon, 576 for double barrel and 320 for single barrel.
            if (this._animationOffset <= 640) {
...
atd.Player.GUN_POS_X = Math.floor(atd.SCREEN_WIDTH * 0.34); // hand animation full sprites offset
atd.Player.GUN_POS_Y = atd.SCREEN_HEIGHT - 128 * atd.Player.GUN_SCALE;
atd.Player.initial_health = 100;
...
atd.ET = ge.Class.create(atd.AnimatedSprite, atd.MovingSprite, {
    ...
    init : function(id, x, y, controller) {
        ...
        this._deadSound.src = "assets/sfx/grenade_ET.ogg";
        ...
        this._state = {
            ...
            x               : x,
            y               : y,
            spriteAtlas     : "assets/graphix/grenade_ET2.png",
            isMoving        : true,
            drawOnMinimap   : true,
            minimapColor    : "limegreen",
            spriteScaleX    : 0.5,
            spriteScaleY    : 0.5,
            spriteOffsetX   : 0,
            speed           : 1
...
atd.Demon = ge.Class.create(atd.AnimatedSprite, atd.MovingSprite, {
    ...
    init : function(id, x, y, controller) {
        ...
        this._deadSound = new Audio();
        this._deadSound.src = "assets/sfx/grenade_demon_dead.ogg";
        ...
        this._state = {
            ...
            x               : x,
            y               : y,
            spriteAtlas     : "assets/graphix/grenade_demon2.png",
            isMoving        : true,
            drawOnMinimap   : true,
            minimapColor    : "pink",
            spriteOffsetX   : 0,
        ...
        this.runMove(800); //cyberdemonmovespeed
    },
    ...
    kill : function () {
        ...
        this.runAnimation(512, 1152, {
            speed     : 150,
            singlerun : true
        }, ge.bind(function () {
            this._state.spriteOffsetX = 1152;
        }, this));
